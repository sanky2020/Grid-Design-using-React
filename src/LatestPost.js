        ...
        return (
            <div>
                ...
                <article className="items">
                    <a href="/">
                    <img className="item-image" src="https://edyoda.s3.amazonaws.com/media/blog-images/edyoda_WxvDSK1.jpg" alt="cards-Pic"/>
                ...
                <article className="items">
                    <a href="/" ><img className="item-image" src="https://edyoda.s3.amazonaws.com/media/blog-images/edyoda_blog_aws_cloudday_17may2018_Bangalore_small_ByulIE.jpg" alt="cards-Pic"/>
                    <div className="item-text-section">
                ...
                <article className="items">
                    <a href="/" ><img className="item-image" src="https://edyoda.s3.amazonaws.com/media/blog-images/1_G1i7GlRPMGboYZdRhOeWaw.png" alt="cards-Pic"/>
                    <div className="item-text-section">
                ...
                <article className="items">
                    <a href="/"><img className="item-image" src="https://edyoda.s3.amazonaws.com/media/blog-images/what_is_isa_blog_1.png" alt="cards-Pic"/>
                    <div className="item-text-section">
                ...
                <article className="items">
                    <a href="/" ><img className="item-image" src="https://edyoda.s3.amazonaws.com/media/blog-images/EdYoda_Admission_Test_Image.png" alt="cards-Pic"/>
                    <div className="item-text-section">
                ...
                <article className="items">
                    <a href="/" ><img className="item-image" src="https://edyoda.s3.amazonaws.com/media/blog-images/7_reasons_to_learn_Python_u3lFION.jpg" alt="cards-Pic"/>
                    <div className="item-text-section">
